...
import com.example.comp7506_1.todolist.Utils.CountDownTimer;
import com.example.comp7506_1.todolist.Utils.NetWorkUtils;
import com.example.comp7506_1.todolist.Utils.SPUtils;
import com.example.comp7506_1.todolist.Utils.Sound;
import com.example.comp7506_1.todolist.Utils.TimeFormatUtil;
import com.example.comp7506_1.todolist.Bean.User;
import com.example.comp7506_1.todolist.Utils.WakeLockHelper;
...
public class ClockService extends Service implements CountDownTimer.OnCountDownTickListener {
    public static final String ACTION_COUNTDOWN_TIMER =
            "com.example.comp7506_1.todolist.COUNTDOWN_TIMER";
    public static final String ACTION_START = "com.example.comp7506_1.todolist.ACTION_START";
    public static final String ACTION_PAUSE = "com.example.comp7506_1.todolist.ACTION_PAUSE";
    public static final String ACTION_RESUME = "com.example.comp7506_1.todolist.ACTION_RESUME";
    public static final String ACTION_STOP = "com.example.comp7506_1.todolist.ACTION_STOP";
    public static final String ACTION_TICK = "com.example.comp7506_1.todolist.ACTION_TICK";
    public static final String ACTION_FINISH = "com.example.comp7506_1.todolist.ACTION_FINISH";
    public static final String ACTION_AUTO_START
            = "com.example.comp7506_1.todolist.ACTION_AUTO_START";
    public static final String ACTION_TICK_SOUND_ON =
            "com.example.comp7506_1.todolist.ACTION_TICK_SOUND_ON";
    public static final String ACTION_TICK_SOUND_OFF =
            "com.example.comp7506_1.todolist.ACTION_TICK_SOUND_OFF";
    public static final String ACTION_POMODORO_MODE_ON =
            "com.example.comp7506_1.todolist.ACTION_POMODORO_MODE_OFF";
    public static final String ACTION_CHANGE_MUSIC = "com.example.comp7506_1.todolist.ACTION_CHANGE_MUSIC";
