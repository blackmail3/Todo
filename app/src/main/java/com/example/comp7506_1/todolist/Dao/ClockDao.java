package com.example.comp7506_1.todolist.Dao;
...
public class ClockDao {
    ...
    public List<Tomato> getDbAllTomato() {
        ...
        cursor.close();
        close();
        Log.i("ClockDao", "The number of local tomato tasks was queried" + tomatoList.size());
        return tomatoList;
    }
...
//                    Log.i("Clock", "Number of tomato clocks:" + allTimes);
//                    Log.i("Clock", "Time:" + allDuration);
                } else {
