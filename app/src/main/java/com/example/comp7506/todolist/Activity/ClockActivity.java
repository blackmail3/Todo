...
import com.example.comp7506.todolist.Service.FocusService;
import com.example.comp7506.todolist.Utils.SPUtils;
import com.example.comp7506.todolist.Utils.TimeFormatUtil;
import com.example.comp7506.todolist.Service.ClockService;
import com.example.comp7506.todolist.Widget.RippleWrapper;
import com.example.comp7506.todolist.Widget.ClockApplication;
import com.example.comp7506.todolist.Widget.ClockProgressBar;
...
public class ClockActivity extends BasicActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toasty.normal(this, "Double-click the screen to turn on or off white noise", Toast.LENGTH_SHORT).show();
        initActions();
        initBackgroundImage();
    }
    ...
    private void initActions() {
        ...
        mBtnStop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                exitDialog.setTitle("Alert")
                        .setMessage("After giving up, this tomato clock will be invalid")
        ...
        bt_music.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alert.setPositiveButton("Close", new View.OnClickListener(){
                    @Override
                    public void onClick(View view) {
                        alert.dismiss();
                    }
...
//                    }).show();
            ...
            exitDialog.setTitle("Alert")
                    .setMessage("This time the tomato clock will be invalid, whether to quit?")
